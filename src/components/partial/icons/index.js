...
export const HumidityIcon = ({color}) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill={color} className="mb-1 bi bi-droplet"
      viewBox="0 0 16 16">
...
export const WindIcon = ({color}) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill={color} className="mb-1 bi bi-wind"
      viewBox="1 0 16 16">
      <path
...
export const BurgerIcon = ({color}) => {
  return(
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill={color} className="bi bi-list"
      viewBox="0 0 16 16">
      <path fillRule="evenodd"
